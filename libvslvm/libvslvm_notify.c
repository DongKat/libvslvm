...
{
	static char *function = "libvslvm_notify_set_stream";
...
int libvslvm_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libvslvm_notify_stream_open";
...
int libvslvm_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libvslvm_notify_stream_close";

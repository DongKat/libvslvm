...
PySequenceMethods pyvslvm_physical_volumes_sequence_methods = {
	/* sq_length */
	(lenfunc) pyvslvm_physical_volumes_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyvslvm_physical_volumes_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyvslvm_physical_volumes_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyvslvm.physical_volumes",
	/* tp_basicsize */
	sizeof( pyvslvm_physical_volumes_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyvslvm_physical_volumes_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_as_sequence */
	&pyvslvm_physical_volumes_sequence_methods,
	/* tp_as_mapping */
	0,
	/* tp_hash */
	0,
	...
	/* tp_doc */
	"pyvslvm sequence and iterator object of physical volumes",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyvslvm_physical_volumes_iter,
	/* tp_iternext */
	(iternextfunc) pyvslvm_physical_volumes_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyvslvm_physical_volumes_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
PyObject *pyvslvm_physical_volumes_new(
           ...
           int number_of_items )
{
	pyvslvm_physical_volumes_t *sequence_object = NULL;

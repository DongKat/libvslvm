...
#if !defined( _VSLVM_TEST_GETOPT_H )
#define _VSLVM_TEST_GETOPT_H
...
#define vslvm_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t vslvm_test_getopt(
                  int argument_count,
...
#endif /* !defined( _VSLVM_TEST_GETOPT_H ) */

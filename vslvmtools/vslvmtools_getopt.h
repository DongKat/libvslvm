...
#if !defined( _VSLVMTOOLS_GETOPT_H )
#define _VSLVMTOOLS_GETOPT_H
...
#define vslvmtools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t vslvmtools_getopt(
                  int argument_count,
...
#endif /* !defined( _VSLVMTOOLS_GETOPT_H ) */
